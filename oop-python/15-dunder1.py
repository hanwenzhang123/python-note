introduce polymorphism to our class definitions is by using Python’s special dunder methods.

the constructor __init__() 
the string representation method __repr__
...
Well, Python offers the dunder method __add__ for this very reason! If we rename the add() method above to something that looks like this:
  class Color: 
