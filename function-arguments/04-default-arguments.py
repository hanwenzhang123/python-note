...
It assumes the default value for is_admin: False. We can make both of our parameters have a default value (therefore making them all optional).
...
# a function called make_folders(). We want to add a default argument to the nest parameter in make_folders().
